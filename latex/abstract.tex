...
To this purpose, we develop an \emph{abstract computational model of automatically differentiable programs} of arbitrary order. In the model, programs are elements of \emph{programming spaces} and are viewed as maps from the \emph{virtual memory space} to itself.
