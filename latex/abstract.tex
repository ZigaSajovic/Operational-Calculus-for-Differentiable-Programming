...
\begin{abstract}
  ...
  present an algebraic language that presents formal semantics of
  differentiable programs by way of \emph{operational calculus}, which enables
  reasoning about their analytic properties.
